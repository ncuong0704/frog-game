function CHelpPanel(){
    ...
    this._init = function(){
        ...
        /*
        _oText1Back = new createjs.Text(_oMessage1,"bold 18px "+PRIMARY_FONT, "#000000");
	...
	_oText1 = new createjs.Text(_oMessage1,"bold 18px "+PRIMARY_FONT, "#fcff00");
        ...
        _oText2Back = new createjs.Text(TEXT_HELP2,"bold 22px "+PRIMARY_FONT, "#000000");
	...
	_oText2 = new createjs.Text(TEXT_HELP2,"bold 22px "+PRIMARY_FONT, "#fcff00");
        ...
        _oText3Back = new createjs.Text(TEXT_HELP3,"bold 22px "+PRIMARY_FONT, "#000000");
	...
	_oText3 = new createjs.Text(TEXT_HELP3,"bold 22px "+PRIMARY_FONT, "#fcff00");
        ...
        _oText4Back = new createjs.Text(TEXT_HELP4,"bold 22px "+PRIMARY_FONT, "#000000");
	...
	_oText4 = new createjs.Text(TEXT_HELP4,"bold 22px "+PRIMARY_FONT, "#fcff00");
